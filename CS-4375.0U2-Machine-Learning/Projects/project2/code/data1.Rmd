...
dataPathHomeComputer <- "C:\\Users\\Kim\\Desktop\\data\\traffic-tickets-issued-four-year-window.csv"
...
# a
library(e1071)
nb1 <- naiveBayes(train_data[,-1], train_data[,1], data=train_data)
...
# c
table(p1, test_data[,-1], type="class")

# d
paste("The mean accuracy is:", mean(p1==test_data[,-1]))
