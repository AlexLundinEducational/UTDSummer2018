...
# train_xPredictor_hp <- train_data$horsepower
# train_yResponse_mpg <- train_data$mpg
# scatter.smooth(x=train_xPredictor_hp, train_yResponse_mpg, main="MPG ~ Horsepower", xlab="Horsepower", ylab="Mpg")  # scatterplot
# 
# 
# # box plot for outliers, anything between 25% and 75% percentiles
# par(mfrow=c(1, 2))  # divide graph area in 2 columns
# boxplot(train_xPredictor_hp, main="horsepower", sub=paste("Outlier rows: ", boxplot.stats(train_xPredictor_hp)$out))  # box plot for 'speed'
# boxplot(train_yResponse_mpg, main="MPG", sub=paste("Outlier rows: ", boxplot.stats(train_yResponse_mpg)$out))  # box plot for 'distance'
# 
# 
# if(!require("e107")){
# # install auto_dataFrame if needed
...
# # Density plot
# par(mfrow=c(1, 2))  # divide graph area in 2 columns
# plot(density(train_xPredictor_hp), main="Density Plot: Speed", ylab="Frequency", sub=paste("Skewness:", round(e1071::skewness(train_xPredictor_hp), 2)))  # density plot for 'speed'
# polygon(density(train_xPredictor_hp), col="red")
# plot(density(train_yResponse_mpg), main="Density Plot: Distance", ylab="Frequency", sub=paste("Skewness:", round(e1071::skewness(train_yResponse_mpg), 2)))  # density plot for 'dist'
# polygon(density(train_yResponse_mpg), col="red")
# 
# 
# # correlation
# cor(train_xPredictor_hp, train_yResponse_mpg)  # calculate correlation between speed and distance 
# 
# # create linear model on train_data
# train_linearModel <- lm(train_xPredictor_hp ~ train_yResponse_mpg, data=train_data)
# print(train_linearModel)
# plot(train_linearModel)
# # create summary
...
# 
# 
# #Step 2: Develop the model on the train_data data and use it to predict the distance on test_data data
# # Predict from the linearModel of the train_data and the train_data data
...
# The blue fis the data fairly well because it uses the linearmodel generated from the data.
